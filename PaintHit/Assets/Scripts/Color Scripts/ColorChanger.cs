...
public class ColorChanger : MonoBehaviour
{
    void OnCollisionEnter(Collision target)
    {
        ...
        {
            base.gameObject.GetComponent<Collider>().enabled = false;
            GameObject gameObjectSplash = Instantiate(Resources.Load("splash1")) as GameObject;
            gameObjectSplash.transform.parent = target.gameObject.transform;
            Destroy(gameObjectSplash, 0.1f);
